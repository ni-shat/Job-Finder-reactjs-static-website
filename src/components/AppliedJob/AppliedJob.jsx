...
const AppliedJob = ({ appliedJob }) => {
    ...
    return (
        <div className='border rounded-md p-4 flex gap-7 items-center mb-6'>

            <div className='w-36 h-36 p-3 rounded-md bg-[#F4F4F4] flex justify-center items-center'>
                <img className='object-contain' src={appliedJob.logo} alt="" />
            </div>

            <div className='flex-grow space-y-2'>
                <h3 className='text-xl font-bold text-[#474747]'>{appliedJob.jobTitle}</h3>
                ...
                <div className='flex text-[#7d7d7d] gap-8'>
